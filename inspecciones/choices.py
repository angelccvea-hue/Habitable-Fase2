...
class Estado2daRonda(models.TextChoices):
    ...
    # Cola del revisor (entre Borrador y Revisado) — sugerido por operación 16/09/2026
    PENDIENTE_REVISION = "Pendiente revisión", "Pendiente revisión"
    REVISADO = "Revisado", "Revisado"
    APROBADO = "Aprobado", "Aprobado"
    PUBLICADO = "Publicado", "Publicado"


# Cola operativa del revisor (chip «Para revisar»)
ESTADOS_COLA_REVISION = (
    Estado2daRonda.PENDIENTE_REVISION,
    Estado2daRonda.REVISADO,  # legado / ya marcados como revisados pendientes de aprobar
)
...
class UnidadMetrado(models.TextChoices):
    M = "m", "m (metro lineal)"
    M2 = "m²", "m²"
    M3 = "m³", "m³"
    UND = "und", "und (unidad)"
    KG = "kg", "kg"
    ML = "m.l.", "m.l."
    GLB = "glb", "glb (global / lote)"
    PISO = "piso", "piso(s)"
    PENDIENTE = "Pendiente", "Pendiente"


class ElementoMetrado(models.TextChoices):
    COLUMNA = "Columna", "Columna"
    VIGA = "Viga", "Viga"
    MURO = "Muro / pantalla", "Muro / pantalla"
    LOSA = "Losa", "Losa"
    ESCALERA = "Escalera", "Escalera"
    FACHADA = "Fachada", "Fachada"
    SOTANO = "Sótano / semisótano", "Sótano / semisótano"
    CIMENTACION = "Cimentación", "Cimentación"
    EDIFICIO = "Edificio completo", "Edificio completo"
    ENTORNO = "Entorno / vía", "Entorno / vía"
    OTRO = "Otro", "Otro"
    PENDIENTE = "Pendiente", "Pendiente"


class AccionMetrado(models.TextChoices):
    APUNTALAR = "Apuntalar / shoring", "Apuntalar / shoring"
    REPARAR = "Reparar", "Reparar"
    REFORZAR = "Reforzar", "Reforzar"
    DEMOLER = "Demoler", "Demoler"
    RETIRAR = "Retirar / desmontar", "Retirar / desmontar"
    ACORDONAR = "Acordonar / proteger", "Acordonar / proteger"
    MONITOREAR = "Monitorear", "Monitorear"
    ESTUDIAR = "Estudio / ensayo", "Estudio / ensayo"
    OTRO = "Otro", "Otro"
    PENDIENTE = "Pendiente", "Pendiente"


class ConfianzaMetrado(models.TextChoices):
    ALTA = "Alta", "Alta"
    MEDIA = "Media", "Media"
...
class GrupoPartida(models.TextChoices):
    APUNT = "APUNTAMIENTO", "Apuntamiento / seguridad"
    REP = "REPARACION", "Reparación / refuerzo"
    FIS = "FISURAS", "Fisuras / grietas"
    DEM = "DEMOLICION", "Demolición"
    ESC = "ESCOMBROS", "Escombros / retiro"
    EST = "ESTUDIOS", "Estudios / complementos (D1)"
    FAC = "FACHADA", "Fachada / no estructural"
    MOV = "MOVILIZACION", "Movilización / logística"
    OTRO = "OTRO", "Otro"


class TipoApuntamiento(models.TextChoices):
    """Post-sísmico: estabilizar el edificio dañado vs sostener durante la intervención."""

    PREVENTIVO = "preventivo", "Preventivo (estabilización post-sísmica)"
    TRABAJO = "trabajo", "De trabajo (durante la intervención)"
    AMBOS = "ambos", "Preventivo + trabajo"
    NA = "na", "No aplica"
